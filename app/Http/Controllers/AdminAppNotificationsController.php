...
class AdminAppNotificationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
		...
		$this->col = [];
		$this->col[] = ["label"=>"اسم المستخدم","name"=>"(select username from application_users where id = user_id) as user_id"];
		$this->col[] = ["label"=>"المحتوى","name"=>"content"];
		$this->col[] = ["label"=>"تاريخ الارسال","name"=>"created_at"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
		$this->form = [];
		$this->form[] = ['label'=>'المستخدم','name'=>'user_id','type'=>'datamodal','datamodal_table'=>'application_users','datamodal_columns'=>'username','datamodal_columns_alias'=>'اسم المستخدم'];	

		$this->form[] = ['label'=>'المحتوى','name'=>'content','type'=>'textarea','validation'=>'required|string|min:3','width'=>'col-sm-10'];
