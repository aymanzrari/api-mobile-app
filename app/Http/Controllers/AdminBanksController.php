<?php namespace App\Http\Controllers;
	...
	class AdminBanksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"اسم البنك","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'اسم البنك','name'=>'name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			
			$this->form[] = ['label'=>'IBAN','name'=>'iban','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
