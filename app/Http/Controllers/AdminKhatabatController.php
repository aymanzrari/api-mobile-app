<?php namespace App\Http\Controllers;
	...
	class AdminKhatabatController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] =
				['label'=>'الدولة','name'=>'country_code','type'=>'select2','datatable'=>'countries,native_name','datatable_where'=>'status != \'0\'','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'المنطقة','name'=>'region','type'=>'text','validation'=>'string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'فضلا ادخل احرف فقط'];
